...
class _ChatListScreenState extends State<ChatListScreen>
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              title: Text(
                name.toString(),
                style: GoogleFonts.poppins(
                  color: status == 'missed' ? Colors.redAccent : Colors.white,
                  fontWeight: FontWeight.w600,
                ),
              ),
              subtitle: Text(
  ...
  Widget build(BuildContext context) {
    ...
    final fieldFillColor = Theme.of(context).brightness == Brightness.dark
  ...
  Widget _buildThreadTile(Map<String, dynamic> t) {
    ...
    return ListTile(
      ...
      subtitle: Text(
        ...
        overflow: TextOverflow.ellipsis,
        style: GoogleFonts.poppins(
          color: effectiveUnread ? Colors.white : Colors.white60,
          fontSize: 12,
